     ...
     attachEventListeners() {
          ...
          exploreButtons.forEach(button => {
               button.addEventListener('click', (e) => {
                    ...
                    this.handleExploreClick(provinceId)
               })
          })
     }

     handleExploreClick(provinceId) {
          window.location.href = `/pages/detailPage.html?provinceId=${provinceId}`
     }
}