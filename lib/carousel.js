export class Carousel {
     ...
     updateSlidesPerView() {
          this.currentSlidesPerView = window.innerWidth < 768
     ...
     updateSlideWidth() {
          ...
          const totalGapWidth = totalGaps * this.options.slideGap
     ...
     applySlideStyles() {
          this.elements.slides.forEach(slide => {
               ...
               slide.style.marginRight = `${this.options.slideGap}px`
     ...
     drag(e) {
          ...
          const minTranslate = -((this.elements.slides.length - this.currentSlidesPerView) *
               (this.state.slideWidth + this.options.slideGap))
     ...
     stopDragging() {
          ...
          const slideUnit = this.state.slideWidth + this.options.slideGap
